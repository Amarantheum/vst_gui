...
pub fn compile_shader(src: &str, ty: GLenum) -> Result<GLuint, Box<dyn Error>> {
    let shader;
    unsafe {
...
pub fn link_program(vs: GLuint, fs: GLuint) -> Result<GLuint, Box<dyn Error>> {
    unsafe {
